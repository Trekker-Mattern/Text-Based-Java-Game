...
public abstract class monsterArrayList {
    ...
    public static ArrayList<Class<? extends boss>> bossSubclasses = new ArrayList<Class<? extends boss>>(Arrays.asList(cthulhu.class, hydra.class, thor.class, mothMan.class));
